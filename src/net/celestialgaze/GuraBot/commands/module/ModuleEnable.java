...
public class ModuleEnable extends Subcommand {

	public ModuleEnable(Command parent) {
		super(new CommandOptions()
				.setName("enable")
				.setDescription("Enables a module in your server")
	...
	protected void run(Message message, String[] args, String[] modifiers) {
		...
		module.setEnabled(message.getGuild().getIdLong());
		SharkUtil.success(message, "Enabled **" + module.getName() + "** module!");
	}
